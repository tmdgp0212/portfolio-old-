                    ...
                    <div className="about-me">
                        ...
                        <ul>
                            <li>
                                <span>01.</span>
                                <p>
                                    <strong>웹 표준 html5</strong>의 특성을
                                    이해하고 능숙하게 다룹니다.
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                <span>05. </span>
                                <p>
                                    <strong>Javascript ES5</strong> 의
                                    작동원리를 이해하고,
                                    <strong>
                                        {" "}
                                        라이브러리의 도움 없이 다양한 기능을
                                        구현
                                    </strong>
                                    합니다.
                                </p>
                            ...
                            <li>
                                <span>06. </span>
                                <p>
                                    <strong>jQuery</strong>를 활용하여 동적으로
                                    웹 사이트를 구현합니다.
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                <span>08. </span>
                                <p>
                                    <strong>styled-components</strong>를
                                    사용하여 페이지를 디자인합니다.
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                <span>10. </span>
                                <p>
                                    <strong>GitHub</strong>로 사이트를 배포하여
                                    소스를 관리하고 공유한 경험이 있습니다.
                                </p>
                            </li>
                            <li>
                                <span>11. </span>
                                <p>
                                    <strong>UI/UX에 대한 이해</strong>를
                                    바탕으로 사용자입장에서 고민하여 개발
                                    합니다.
                                </p>
                            </li>
                        </ul>
                    ...
                    <div className="about-me">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>05.</span>
                                <p>
                                    <strong>기본기를 탄탄하게</strong> 다져
                                    스스로에게
                                    <strong> 떳떳한 개발자</strong>가
                                    되고자합니다.
                                </p>
                            </li>
                            <li>
